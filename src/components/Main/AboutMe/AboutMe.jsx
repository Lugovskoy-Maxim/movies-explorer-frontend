...
и дочь. Я люблю слушать музыку, а ещё увлекаюсь бегом. Недавно начал кодить. С 2015 года работал в компании «СКБ Контур». После того, как прошёл курс по веб-разработке, начал заниматься фриланс-заказами и ушёл с постоянной работы.</p>
          ...
          <ul className="aboutMe__partfolio_links">
            <li className="aboutMe__partfolio_link">
              <a className="aboutMe__partfolio_project"  target="_blank" href="https://github.com/Lugovskoy-Maxim/react-mesto-api-full">Страничный сайт</a>
              <p className="aboutMe__partfolio_icon">↗</p>
            </li>
          <li className="aboutMe__partfolio_link">
              <a className="aboutMe__partfolio_project"  target="_blank" href="https://github.com/Lugovskoy-Maxim/russian-travel">Адаптивный сайт</a>
              <p className="aboutMe__partfolio_icon">↗</p>
            </li>            <li className="aboutMe__partfolio_link">
              <a className="aboutMe__partfolio_project"  target="_blank" href="https://github.com/Lugovskoy-Maxim/how-to-learn">Одностраничное приложение</a>
              <p className="aboutMe__partfolio_icon">↗</p>
            </li>
          </ul>
        </section>
